...
func FormatActivityEndConfirmation(startTimeStr, endTimeStr string) *linebot.FlexMessage {
	...
	return linebot.NewFlexMessage("บันทึกเวลากิจกรรม", bubble)
}
